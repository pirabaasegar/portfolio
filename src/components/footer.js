    ...
    <footer>
      <div className="container px-lg-0 px-4">
        <div className="row gap-lg-5 gap-3 align-items-center">
          <div className="col">
            <h3 className="footer-title navbar-brand mb-0 text-lg-start">
              PiRaBaa
            </h3>
          ...
          <div className="col-auto">
            <ul>
              ...
              {/*<li><a href="https://tks.life/profile/pirabaa.segar/"><img src="https://images.prismic.io/pirabaa/ZjL7okMTzAJOCexU_TKS.png?auto=format,compress" width="33px" alt="TKS"></a></li>*/}
            </ul>
            <span
              style={{
                fontSize: 13,
